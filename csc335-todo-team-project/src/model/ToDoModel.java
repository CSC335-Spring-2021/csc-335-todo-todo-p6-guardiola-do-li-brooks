...
public class ToDoModel implements Serializable {
     ...
     * 
     * The view will be automatically added to this new list provided that the
     * addObserver method was used at least once before the calling of this method.
     * 
     ...
     * 
     * This method does not check to make sure that there is more than 1 list to be
     * deleted. That is the responsibility of whatever called this to check to
    ...
    /**
     * Iterates to the next list. Will loop back to the start if there is no next
     * list.
     */
    ...
    /**
     * Renames the current list to the given name and then notifies the view that
     ...
     * 
     * Will also store the Observer so that this model can add this Observer to any
     * newly created lists.
     * 
    ...
    /**
     * Saves this controller which houses all the lists for the ToDo lists in the
     * file save.dat
     * 
     ...
     * 
     * Possible ways that the list can be sorted by: Name, Deadline, Importance,
     * Create Time, Custom
     * 
